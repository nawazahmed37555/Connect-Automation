...
public class PrintersPageObjects {
	//Search  panel
	
	public @FindBy (name= "search_name") WebElement search_printer_name;
	...
	public @FindBy (xpath= "//*[@id='unique_id']/tbody/tr[2]/td[3]") WebElement searchResults_printerName;
	...
	//Add/edit panel
	public @FindBy (name= "edit_name") WebElement edit_printerName;
	...
	public @FindBy (name= "edit_communicationMethod") WebElement edit_drpDown_communicationMethod;
	public @FindBy (name= "edit_dpi") WebElement edit_drpDown_dpi;
