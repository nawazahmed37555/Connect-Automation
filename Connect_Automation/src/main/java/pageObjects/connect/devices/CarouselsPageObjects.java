...
public class CarouselsPageObjects {

	//Search Carousels panel
	
	public @FindBy (name= "search_name") WebElement search_carousel_name;
	...
	public @FindBy (xpath= "//*[@id='unique_id']/tbody/tr[2]/td[3]") WebElement searchResults_carouselName;
	...
	//Add/edit panel
	public @FindBy (name= "edit_name") WebElement edit_CarouselName;
	...
	//Test data
	public String[] carousel_name = {"Automated_carousel1","Automated_Carousel2"};
